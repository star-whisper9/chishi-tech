...
/**
 * AI 画皮肤页面的图标。
 * 用法：<AIGeneraionImage fontSize="large" color="primary" />
 */
const AIGeneraionImage = React.forwardRef<SVGSVGElement, SvgIconProps>(
  (props, ref) => {
    return (
...
AIGeneraionImage.displayName = "AIGeneraionImage";
export default AIGeneraionImage;
